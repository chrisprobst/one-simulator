...
public abstract class MessageRouter {
	...
	/**
	 * Returns true if a full message with same ID as the given message has been received by this host as the <strong>final</strong> recipient (at least once).
	 * 
	 * @param m
	 ...
	 *            The message to add
	 * @param newMessage
	 *            If true, message listeners are informed about a new message, if false, nothing is informed.
	 */
	 ...
	 * @param m2
	 *            The second message
	 * @return -1 if the first message should come first, 1 if the second message should come first, or 0 if the ordering isn't defined
	 */
	...
	public String toString() {
		return getClass().getSimpleName() + " of " + this.getHost().toString() + " with " + getNrofMessages() + " messages";
	}
}
