...
public abstract class MessageRouter {
     ...
     */
    public static final int Q_ORDER_BY_ARRIVAL_TIME_DESC = 7;
    public static final int Q_ORDER_BY_REPLICATIONS_DESC = 8;
    public static final int Q_ORDER_BY_HOP_COUNT_DESC = 9;
...
//    	          3- if  it  is  possible  make it  as  choice  for  sending  queue
    ...
    /**
     * Sorts/shuffles the given list according to the given mode.
     * The list can contain either Message or Tuple<Message, Connection>
    ...
    protected List sortByMode(List list, final int mode) {
        switch (mode) {
            case Q_MODE_RANDOM:
            ...
            default:
                Collections.sort(list,
                                 new Comparator() {
                                     /** Compares two tuples by their messages' order */
                                     public int compare(Object o1, Object o2) {
                                         ...
                                         return compareByMode(m1, m2, mode);
                                     }
                                 });
        }
    ...
    private int compareByMode(Message m1, Message m2, int mode) {
        switch (mode) {
            ...
            case Q_ORDER_BY_REPLICATIONS_DESC:
                return Integer.compare(m2.getReplications(), m1.getReplications());
            case Q_ORDER_BY_PACKET_SIZE_DESC:
                return Integer.compare(m2.getSize(), m1.getSize());
            case Q_ORDER_BY_HOP_COUNT_DESC:
