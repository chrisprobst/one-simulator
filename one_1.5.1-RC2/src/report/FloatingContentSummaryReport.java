...
public class FloatingContentSummaryReport extends Report implements MessageListener {
    ...
    public void done() {
        ...
        write("SUM\t0\t0\t0\t0\t" + n_msg + "\t" + (double) success / (double) n_msg + "\t" +
              (double) repl / (double) n_msg + "\t" +
                ...
                for (int r : rs) {
                    for (int a : as) {
                        ...
                        write("TAB\t" + s + "\t" + t + "\t" + r + "\t" + a + "\t" + me.count + "\t" +
                              ...
                              "\t" +
                              me.lifetime.toString("LT", "\t", tmp_count) + "\t" +
                              me.lifecopies.toString("CC", "\t", tmp_count));
                    }
                }
            }
        }
        for (String id : mids) {
            msg = msgs.get(id);
            write("MSG\t" + id + "\t" + msg.anchor.toString() + "\t" + msg.size + "\t" + msg.ttlval + "\t" +
                  (int) msg.r + "\t" + (int) msg.a + "\t" +
                  (msg.copies > 0? 1 : 0) + "\t" + msg.repl + "\t" + msg.abort + "\t" + msg.copies + "\tLT\t" +
                  msg.lifetime / (double) msg.ttlval + "\t" +
